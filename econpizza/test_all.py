...
def test_hank():
    ...
    assert np.allclose(
        x[9], np.array(
            [5.59960670e+00, 9.87067293e-01, 9.99559180e-01,
             1.67843181e-01, 9.99575915e-01, 9.99409400e-01,
             1.00023881e+00, 1.00000000e+00, 9.99886120e-01,
             1.00200000e+00, 1.33726278e-03, 4.84354171e-01,
             3.52866907e-01, 7.86104086e-01, 8.32068866e-01,
             9.99559180e-01, 9.99575915e-01, 1.00000000e+00]
        )
    )
