...
def test_hank():
    ...
    assert np.allclose(
        x[9], np.array(
            [5.59963983e+00, 9.87048580e-01, 9.99549241e-01,
             1.67846121e-01, 9.99564657e-01, 9.99433158e-01,
             1.00025284e+00, 1.00000000e+00, 9.99925873e-01,
             1.00200000e+00, 1.41582593e-03, 4.84355005e-01,
             3.52819624e-01, 7.86144339e-01, 8.32065354e-01,
             9.99549241e-01, 9.99564657e-01, 1.00000000e+00]
        )
    )
